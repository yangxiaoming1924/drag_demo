          ...
          document.addEventListener('mousemove',function(e) {
            ...
            if(moving === true){
              ...
              var position = 'transform: translate('+dx+'px, '+dy+'px);z-index:'+z+';';
                var position2 = 'transform: translate('+dx+'px, '+dy+'px);z-index:'+(z)+';';
                var position3 = 'position:absolute;z-index:'+(z)+';';
                var position4 = 'top: 68vh;left: 38vw;position:absolute;z-index:'+(z+1)+';';
                var position5 = 'position:absolute;z-index:'+(9999)+';';

                tgt.setAttribute('style', position);
                document.querySelector('.upload').setAttribute('style',position2);
                document.querySelector('.draggin_bg').setAttribute('style',position3);
                document.querySelector('button').setAttribute('style',position4);
                document.querySelector('.show').setAttribute('style',position5);
            };
          });
